...
```{r Figure 1, echo=FALSE, out.width='60%', fig.cap= "Subarea 48.1 and management strata considered in the spatio-temporal analysis of intrinsic productivity of Krill (BS=Brainsfield Strait, EI= Elephant Island, Extra= Extra, JOIN= Joinville Island, SSWI= South West)"}
...
```{r fig.cap="\\label{Figure4}Fit of the model to the data of lengths in Braishfield strata", out.width="80%"}
plotSize(fitei,
...
```{r fig.cap="\\label{Figure5}Fit of the model to the data of lengths in Joinville strata", out.width="60%"}
plotSize(fitjo,
...
```{r, fig.cap="\\label{Figure6}Difference between the observed accumulated size structure for each stratum related SPR objective", out.width="80%"}
...
```{r curve_mat, echo=FALSE, fig.cap= "\\label{Figure7}Maturity curves by strata", out.width="80%"}
