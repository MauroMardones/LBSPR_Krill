...
```{r Figure2, echo=FALSE, out.width='80%', fig.cap="Pearson correlation between krill length and temporal (years) and environmental factors in the WAP"}
...
```{r Figure3, echo=FALSE,  out.width='80%', fig.cap="Random effects of location (cell) and fixed effects of environmental variables on krill length, with scattered points indicating variability in impact in estimates of the main variable."}
...
```{r Figure13, warning=FALSE, fig.cap="Sensitivity analysis to 48.1 about asymptotic length VB", fig.height=3, fig.width=7}
...
```{r Figure14, warning=FALSE, fig.cap="Sensitivity analysis to 48.1 about k", fig.height=3, fig.width=7}
...
```{r Figure15, warning=FALSE, fig.cap="Plot to SPR in different context to 48.1 subarea", fig.height=4, fig.width=8}
