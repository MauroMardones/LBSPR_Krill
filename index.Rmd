...
This code with metdology is this
...
```{r, echo =TRUE}
MySim <- LBSPRsim(MyPars, Control=list(modtype="absel", maxFM=5)) 
```
...
A valid LB_pars object must be first created regarding Maschete et al
2016
...
|          |     |     |          |     |     |          |     |     |
|              |     | |              |     | |              |     | |
| |     | von Ber      | |     | von Ber      | |     | von Ber      |
| talanffy             | talanffy             | talanffy             |
|        growt         |        growt         |        growt         |
| h                    | h                    | h                    |
|    |     | t0        |    |     | t0        |    |     | t0        |
|                      |                      |                      |
...
|              |     | |              |     | |              |     | |
| |     | Date -       | |     | Date -       | |     | Date -       |
| start growth         | start growth         | start growth         |
|        perio         |        perio         |        perio         |
| d (dd/mm)            | d (dd/mm)            | d (dd/mm)            |
|    |     | 1-Dec     |    |     | 1-Dec     |    |     | 1-Dec     |
|                      |                      |                      |
|          |     | 30- |          |     | 30- |          |     | 30- |
| Nov          |     | | Nov          |     | | Nov          |     | |
...
|              |     | |              |     | |              |     | |
| |     | Date -       | |     | Date -       | |     | Date -       |
| end growth           | end growth           | end growth           |
|        perio         |        perio         |        perio         |
| d (dd/mm)            | d (dd/mm)            | d (dd/mm)            |
...
|        (kg,          |        (kg,          |        (kg,          |
| mm)                  | mm)                  | mm)                  |
|    |     | Weight-le |    |     | Weight-le |    |     | Weight-le |
| ngth parameter -- A  | ngth parameter -- A  | ngth parameter -- A  |
| (kg)     |     | 1   | (kg)     |     | 1   | (kg)     |     | 1   |
|              |     | |              |     | |              |     | |
| |     |              | |     |              | |     |              |
|                      |                      |                      |
...
| |     | Matu         | |     | Matu         | |     | Matu         |
| rity                 | rity                 | rity                 |
|    |     | Min lengt |    |     | Min lengt |    |     | Min lengt |
| h, 50% are mature    | h, 50% are mature    | h, 50% are mature    |
|          |     | 34  |          |     | 34  |          |     | 34  |
| mm           |     | | mm           |     | | mm           |     | |
| |     |              | |     |              | |     |              |
|                      |                      |                      |
...
| gth, 50% are         | gth, 50% are         | gth, 50% are         |
|        matur         |        matur         |        matur         |
| e                    | e                    | e                    |
|    |     | -         |    |     | -         |    |     | -         |
|                      |                      |                      |
...
| ver which            | ver which            | ver which            |
|        matur         |        matur         |        matur         |
| ity occurs           | ity occurs           | ity occurs           |
|    |     | -         |    |     | -         |    |     | -         |
|                      |                      |                      |
|          |     | -   |          |     | -   |          |     | -   |
|              |     | |              |     | |              |     | |
...
|  of Spawning Season  |  of Spawning Season  |  of Spawning Season  |
| (dd/mm)  |     | 1-M | (dd/mm)  |     | 1-M | (dd/mm)  |     | 1-M |
| ar           |     | | ar           |     | | ar           |     | |
| |     |              | |     |              | |     |              |
|                      |                      |                      |
|    |     |           |    |     |           |    |     |           |
...
|          |     |     |          |     |     |          |     |     |
|              |     | |              |     | |              |     | |
| |     | Last Da      | |     | Last Da      | |     | Last Da      |
| y of                 | y of                 | y of                 |
|        Spawn         |        Spawn         |        Spawn         |
| ing Season (dd/mm)   | ing Season (dd/mm)   | ing Season (dd/mm)   |
...
|          |     |     |          |     |     |          |     |     |
|              |     | |              |     | |              |     | |
| |     | Min Coe      | |     | Min Coe      | |     | Min Coe      |
| fficient of          | fficient of          | fficient of          |
|        Varia         |        Varia         |        Varia         |
| tion                 | tion                 | tion                 |
|    |     | -         |    |     | -         |    |     | -         |
|                      |                      |                      |
...
| 617.426, 1988.91     | 617.426, 1988.91     | 617.426, 1988.91     |
|          |     | -   |          |     | -   |          |     | -   |
|              |     | |              |     | |              |     | |
| |     |              | |     |              | |     |              |
|                      |                      |                      |
...
|          |     |     |          |     |     |          |     |     |
|              |     | |              |     | |              |     | |
| |     | Min len      | |     | Min len      | |     | Min len      |
| gth, 50%             | gth, 50%             | gth, 50%             |
|        Selec         |        Selec         |        Selec         |
| ted                  | ted                  | ted                  |
|    |     | -         |    |     | -         |    |     | -         |
|                      |                      |                      |
...
| ver which            | ver which            | ver which            |
|        recru         |        recru         |        recru         |
| itment occurs        | itment occurs        | itment occurs        |
|    |     | -         |    |     | -         |    |     | -         |
|                      |                      |                      |
|          |     | -   |          |     | -   |          |     | -   |
|              |     | |              |     | |              |     | |
...
|          |     |     |          |     |     |          |     |     |
|              |     | |              |     | |              |     | |
| |     | Catch b      | |     | Catch b      | |     | Catch b      |
| etween               | etween               | etween               |
|        surve         |        surve         |        surve         |
| y and season         | y and season         | y and season         |
|    |     | 0         |    |     | 0         |    |     | 0         |
|                      |                      |                      |
|          |     | 0   |          |     | 0   |          |     | 0   |
|              |     | |              |     | |              |     | |
