...
The LBSPR model described by Hordyk et al. (2015a, b), and tested in a MSE framework [@Hordyk2015a], use a conventional age-structured equilibrium population model. An important assumption of this model structure is that selectivity is age-based not length-based.
