...
glossary <- tribble(
  ...
  "Intrinsic Productivity", "Capacity of a population to replenish itself through growth and reproduction.",
  ...
  "Growth Proxy", "Use of length metrics as indicators of environmental and physiological conditions.",
  ...
  "MSY", "Maximum long-term average catch achievable without harming stock productivity.",
  ...
  "Data-Poor Assessment", "Stock assessment using limited inputs, often only length data.",
  ...
  "Trigger Level", "Catch limit threshold initiating spatial allocation under CM 51-07.",
  ...
  "Management Strata", "Spatial units in 48.1 (BS, EI, GS, JOIN, SSWI).",
  ...
  "Adaptive Allocation", "Adjustment of catch limits across strata based on population indicators.",
  ...
  "Growth Habitat", "Environmental conditions associated with krill somatic growth potential.",
...
```{r kable-version, results='asis', echo=TRUE}
library(kableExtra)
library(dplyr)
