...
```{r warning=FALSE, fig.cap="Krill Intrinsic Productivity (SPR) by strata and by year", fig.height=3}
...
On the other hand, the Bransfield and Extra strata are the area where recruitment overfishing is most intense, as the reproductive potential that ensures the stock is at only 54% and 66.5% respectively  of the recommended target.
