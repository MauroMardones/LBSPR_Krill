...
El presente documento tiene como objetivo aplicar la metodologia del metodo de evualaci?n de stock
basado en datos pobres llamado Length-Based Spawning Potential Ratio (LBSPR) (Hordyk, 2014).  En este ejercicio se estudia el caso de la almeja  (Venus antiqua) de la regi?n XI en el sur de Chile. Este adelanto metodol?gico se ha realizado en las 2 ultimas evaluaciones reportasdas en el proyecto ASIPA "Programa de Seguimiento de pesquer?as Bent?nicas bajo Planes de Manejo".
