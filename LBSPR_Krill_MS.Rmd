...
```{r warning=FALSE, fig.cap="\\label{Figure10}Sensitivity analysis by strata about krill growth type",  out.width='70%'}
#plot
# todo
...
## 4.5. Implications for fisheries management in CCAMLR context
